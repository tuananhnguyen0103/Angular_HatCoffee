...
export class CreateComponent implements OnInit {
  ...
  ngOnInit(): void {
      ...
      this.dataService.GET('api/Product/get-item').subscribe((res:any)=>{
          console.log(res);
          this.products = res
      })
      this.validate()
    ...
    validate() {
        Validator({
          ...
          onSubmit: (products: any) => {
            products={
              product_slug:this.utilityService.makeSeoTitle(products.product_name),
              product_image:this.imageSrc,
              ...products
            }
            console.log(products);
            this.dataService.POST('api/Product/create-item',products).subscribe((res:any)=>{
